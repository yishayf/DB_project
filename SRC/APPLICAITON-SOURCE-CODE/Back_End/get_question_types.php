...
insert_question_type($question_types, 6, "In which of the following competition type did [OLYMPIC ATHLETE] win a medal?", 1, array('a winning olympic athlete name'));
